package com.example.easy_bluetooth.BroadcastReceiver;
...
public class BluetoothStateChangedReceiver extends BroadcastReceiver {
    ...
    public BluetoothStateChangedReceiver(BluetoothAdapter bluetoothAdapter, IntListner listner) {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.e(TAG, "BTHistoryReceiver start");
